...
class APIManager: SessionManager {
    ...
    static let consumerKey = "viGJgO8i0AhyHgt50NxEGce4g"
    static let consumerSecret = "5QJoXynaWsDys9x8VWf2CZCBFat8MMAC4losDuPyt5shImj2yJ"
...
//        }
    ...
    func getUserTimeLine(with id: Int, completion: @escaping ([Tweet]?, Error?) -> ()) {
